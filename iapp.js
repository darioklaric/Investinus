...
var IApp = /** @class */ (function () {
    ...
    IApp.prototype.pickImage = function () {
        var el;
        var txt;
        var value = [];
        if (!this.serialMode) {
        ...
        else { //this.serialMode za knjige i testiranje 
            el = this.counter - 1;
            console.log("PickImage " + this.counter + " " + this.images[el]);
            if (undefined == this.images[el]) { //ako nema više slika pokreni iapp ponovo
                this.counter = 1;
                el = 0;
                //this.createImages();
                //this.startApp();
    ...
    IApp.prototype.createImages = function () {
    ...
    IApp.prototype.drawCards = function () {
        this.startApp();
    };
    IApp.prototype.startApp = function () {
        var _this = this;
        ...
        if (this.testMode) {
            ...
            imageObj.onload = function () {
                _this.ctx.drawImage(imageObj, 10, 10, _this.canvas.width - 20, _this.canvas.height - 20);
            };
        ...
        else { //nacrtaj sliku na pozadinu
