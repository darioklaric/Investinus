...
var mm;
var leavePage;
var ConceptualizationModes;
(function (ConceptualizationModes) {
    ConceptualizationModes[ConceptualizationModes["None"] = 0] = "None";
    ConceptualizationModes[ConceptualizationModes["Normal"] = 1] = "Normal";
    ConceptualizationModes[ConceptualizationModes["Backwards"] = 2] = "Backwards";
    ConceptualizationModes[ConceptualizationModes["Random"] = 3] = "Random";
})(ConceptualizationModes || (ConceptualizationModes = {}));
;
var gameAudioVideoModes;
(function (gameAudioVideoModes) {
    gameAudioVideoModes[gameAudioVideoModes["None"] = 0] = "None";
    gameAudioVideoModes[gameAudioVideoModes["Visual"] = 1] = "Visual";
    gameAudioVideoModes[gameAudioVideoModes["Audio"] = 2] = "Audio";
    gameAudioVideoModes[gameAudioVideoModes["AudioVisual"] = 3] = "AudioVisual";
    gameAudioVideoModes[gameAudioVideoModes["Random"] = 4] = "Random";
})(gameAudioVideoModes || (gameAudioVideoModes = {}));
var writeTextShowImage;
(function (writeTextShowImage) {
    writeTextShowImage[writeTextShowImage["Both"] = 0] = "Both";
    writeTextShowImage[writeTextShowImage["Image"] = 1] = "Image";
    writeTextShowImage[writeTextShowImage["Text"] = 2] = "Text";
})(writeTextShowImage || (writeTextShowImage = {}));
var MM = /** @class */ (function () {
    function MM(myapp) {
        ...
        this.changeTheGame = false;
        this.retries = 0;
        this.videoPlaytime = 0;
        this.showCorrectAnswer = false;
        this.nameTheVideo = false;
        this.vname = ""; //../MMLib/Video/Mia Dimšić-Keksi, cimet,-karamele, čaj.mp4";
        this.lastTextToRead = "";
        ...
        */
        ...
        for (var vn = 0; vn < totalVideos; vn = vn + 1) {
            if (0 <= this.globalRews[vn].indexOf("http")) { //internet videi
    ...
    MM.prototype.OK = function () {
        ...
        //odgovor bio OK
            ...
            this.AdjustStyle("ok");
            var ocanvas = document.getElementById("okcanvas");
    ...
    MM.prototype.DrawGrid = function () {
        ...
        var cnvs = document.getElementById("okcanvas");
        ...
        var _loop_1 = function (y) {
            var _loop_2 = function (x) {
                if (0 == rewDisplay.indexOf("TEKST")) {
                    ...
                    ctx.fillStyle = "red";
                    t = this_1.videosSpec[this_1.videosOrder[c]].replace("../MMLib/Video/", "");
                    t = t.replace(".mp4", "");
                    if (0 > t.indexOf("-")) {
                    ...
                    // kod za tekst + glas
                    var iObj_1 = new Image();
                    iObj_1.onload = function () {
                        ctx.drawImage(iObj_1, x, y, w, h);
                    };
                    av = this_1.videosSpec[this_1.videosOrder[c]];
                    av = av.replace("../MMLib/Video/", "");
                    av = av.replace(".mp4", "");
                    iObj_1.src = "..\\MMLib\\Slike\\m" + a + ".jpg";
                    ctx.drawImage(iObj_1, x, y, w, h);
                }
                else //SLIKA 
                 {
                    // kod za slike
                    var iObj_2 = new Image();
                    iObj_2.onload = function () {
                        ctx.drawImage(iObj_2, x, y, w, h);
                    };
                    av = this_1.videosSpec[this_1.videosOrder[c]];
                    av = av.replace("../MMLib/Video/", "");
                    av = av.replace(".mp4", "");
                    iObj_2.src = "..\\MMLib\\Slike\\m" + a + ".jpg";
                    ctx.drawImage(iObj_2, x, y, w, h);
                }
                c = c + 1;
            };
            for (var x = 0; x < cnvs.width; x = x + w) {
                _loop_2(x);
            }
        };
        var this_1 = this, t, lines, av, av;
        for (var y = cnvs.height / 2; y < cnvs.height; y = y + h) {
            _loop_1(y);
        }
    };
    MM.prototype.NOK = function () {
        AddReason("NOK");
        if (this.rewardStarted) {
            this.rewardStarted = false;
            return;
        ...
        var ncanvas = document.getElementById("nokcanvas");
        ...
        if (this.showCorrectAnswer) {
            ...
            var offsetX = 0; //nctx.measureText(a.answers[0]).width / 2;
            var offsetY = nctxHeight / 4;
    ...
    MM.prototype.RestartApp = function () {
        //panel s igrama
        var apps = "../index.html";
    ...
    ;
    MM.prototype.startRightVideoFromName = function (name) {
        var cnvs = document.getElementById("okcanvas");
        cnvs.width = innerWidth * 0.95;
        cnvs.height = innerHeight * 0.95;
        if (!name)
    ...
    MM.prototype.getRightVideoName = function (inputTxt) {
        var x = -1, y = -1;
    ...
    MM.prototype.startRightVideo = function (x, y) {
    ...
    MM.prototype.AdjustStyle = function (st) {
        //turn off all divs
        if (this.elCanvas)
...
function CalculateEndTime() {
    ...
    var stat = mm.today + " " + ('0' + timestampEnd.getHours()).slice(-2) + ":" + ('0' + timestampEnd.getMinutes()).slice(-2) + ":" + ('0' + timestampEnd.getSeconds()).slice(-2) + " ";
    stat = stat + GetDocURI() + " ";
    if (a.cardsUp > 0)
        stat = stat + " " + a.cardsUp + " ";
...
function PlayVideo() {
    ...
    if (mm.elVideo) { //ovo treba rijesiti preko onpromise buga
...
speechSynthesis.addEventListener("error", function (e) {
    var errorEvent = e;
